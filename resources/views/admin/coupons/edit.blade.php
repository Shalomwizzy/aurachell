        ...
        <div class="grid grid-cols-2 gap-5">
            <div>
                ...
                <input type="text" name="code" value="{{ old('code', $coupon->code) }}" required
                       ...
                       class="w-full bg-white/5 border border-white/10 px-4 py-2.5 text-sm text-white/85 font-mono tracking-widest focus:outline-none focus:border-[#C9A96F]/40 @error('code') border-mahogany/20 @enderror">
            ...
            <div>
                ...
                <select name="type" required
                        class="w-full bg-white/5 border border-white/10 px-4 py-2.5 text-sm text-white/85 focus:outline-none focus:border-[#C9A96F]/40">
