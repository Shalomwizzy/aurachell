...
<div class="p-6 lg:p-8">
    ...
    @endif
    @if(session('error'))
    <div class="mb-6 px-4 py-3 text-sm" style="background:rgba(55,18,32,0.08);border:1px solid rgba(55,18,32,0.22);color:var(--adm-text);">
        {{ session('error') }}
    </div>
    @endif
        ...
        <table class="w-full text-sm">
            ...
            <tr style="border-top:1px solid var(--adm-border);">
                ...
                <td class="px-4 py-4 text-center">
                    <button onclick="var r=document.getElementById('{{ $acId }}');r.style.display=r.style.display==='none'?'':'none';"
                    ...
                    <div class="flex items-center justify-end gap-2">
                        ...
                        <form action="{{ route('admin.abandoned-carts.destroy', $cart) }}" method="POST">
                            ...
                            <button type="submit"
                                    ...
                                    class="px-3 py-1.5 text-[10px] tracking-wider uppercase transition-colors"
                                    style="border:1px solid var(--adm-border);color:var(--adm-muted);"
                                    onmouseover="this.style.borderColor='var(--adm-text)';this.style.color='var(--adm-text)'"
            ...
            <tr id="{{ $acId }}" style="display:none;border-top:1px solid var(--adm-border);background:rgba(55,18,32,0.06);">
