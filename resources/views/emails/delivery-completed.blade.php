...
{{-- Delivery badge --}}
<table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%"
       style="background:rgba(55,18,32,0.10);border:1px solid rgba(55,18,32,0.22);padding:20px 28px;margin:24px 0;text-align:center;">
    <tr>
        <td>
...
<table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="margin-bottom:16px;">
    <tr>
        ...
        <td>
            <p style="font-family:Georgia,serif;font-size:14px;color:#371220;margin:0 0 4px;font-weight:600;">{{ $tip }}</p>
            <p style="font-family:Arial,sans-serif;font-size:12px;color:rgba(55,18,32,0.55);margin:0;line-height:1.6;">{{ $desc }}</p>
        </td>
    </tr>
</table>
@endforeach
...
<table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%"
    ...
    <tr>
        <td>
            ...
            <p style="font-family:Arial,sans-serif;font-size:13px;color:rgba(55,18,32,0.55);margin:0 0 18px;line-height:1.6;">
