        ...
        <div class="flex items-start justify-between gap-4">
            <div class="flex-1">
                <div class="flex items-center gap-3 mb-2">
                    ...
                    @if($zone->is_active)
                    <span class="text-[10px] px-2 py-0.5 tracking-widest uppercase" style="background:rgba(34,197,94,0.1);color:#4ade80;">Active</span>
                    @else
                    <span class="text-[10px] px-2 py-0.5 tracking-widest uppercase" style="background:rgba(156,163,175,0.1);color:#9ca3af;">Inactive</span>
                    @endif
                </div>
            ...
            <div class="flex items-center gap-2 flex-shrink-0">
                ...
                <form method="POST" action="{{ route('admin.shipping.destroy', $zone) }}"
                    ...
                    @csrf @method('DELETE')
                    <button type="submit" class="px-3 py-1.5 text-xs" style="background:rgba(239,68,68,0.1);color:#f87171;">Delete</button>
                </form>
            </div>
        </div>
    </div>
