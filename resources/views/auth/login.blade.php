...
<div class="min-h-screen flex">
    ...
    <div class="hidden lg:flex lg:w-[55%] relative flex-col justify-between overflow-hidden"
         style="background: linear-gradient(145deg, #371220 0%, #371220 50%, #371220 100%);">

        {{-- Texture --}}
        <div class="absolute inset-0" style="background-image:radial-gradient(ellipse at 20% 20%, rgba(55,18,32,0.10) 0%,transparent 60%),radial-gradient(ellipse at 80% 80%, rgba(55,18,32,0.06) 0%,transparent 60%);"></div>

        {{-- Decorative rings --}}
        <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 pointer-events-none">
            <div class="w-[700px] h-[700px] rounded-full" style="border:1px solid rgba(55,18,32,0.06);"></div>
            <div class="absolute inset-0 flex items-center justify-center">
                <div class="w-[500px] h-[500px] rounded-full" style="border:1px solid rgba(55,18,32,0.10);"></div>
            </div>
            <div class="absolute inset-0 flex items-center justify-center">
                <div class="w-[320px] h-[320px] rounded-full" style="border:1px solid rgba(55,18,32,0.16);"></div>
            </div>
        </div>
        ...
        <div class="relative z-10 p-14">
            <a href="{{ route('home') }}" class="inline-flex items-center gap-3 group">
                ...
                <span class="font-display text-xl tracking-[0.25em] uppercase transition-colors" style="color:#371220;">Aurachell</span>
                @endif
            </a>
        </div>
    ...
    <div class="flex-1 flex flex-col" style="background:#FAF5ED;">
        ...
        <div class="flex-1 flex items-center justify-center px-8 lg:px-16 py-12">
            <div class="w-full max-w-sm">
                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-6">
                    ...
                    <div>
                        <label class="block text-[10px] tracking-[0.25em] uppercase mb-3" style="color:rgba(201,169,111,0.55);">Email Address</label>
                        <input type="email" name="email" value="{{ old('email') }}" required autofocus autocomplete="email"
                               ...
                               style="border-color:rgba(201,169,111,0.20);color:#371220;"
                    ...
                    <div>
                        <div class="flex items-center justify-between mb-3">
                            <label class="block text-[10px] tracking-[0.25em] uppercase" style="color:rgba(201,169,111,0.55);">Password</label>
                            @if(Route::has('password.request'))
                            <a href="{{ route('password.request') }}" class="text-[10px] tracking-wider underline underline-offset-4 transition-colors" style="color:rgba(201,169,111,0.65);">Forgot?</a>
                            @endif
                        </div>
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <label for="remember" class="text-xs cursor-pointer select-none" style="color:rgba(201,169,111,0.65);">Keep me signed in</label>
                    </div>
        ...
        <div class="px-8 lg:px-16 py-6 border-t" style="border-color:rgba(201,169,111,0.10);">
