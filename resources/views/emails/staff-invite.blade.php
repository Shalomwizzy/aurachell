...
<div style="background:rgba(255,255,255,0.03);border:1px solid rgba(107,32,22,0.12);padding:28px;margin:28px 0;">
    ...
    <p style="font-size:12px;color:rgba(44,15,10,0.55);font-family:Arial,sans-serif;margin:0;">Please change your password after first login.</p>
</div>
