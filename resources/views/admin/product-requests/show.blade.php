        ...
        <div class="space-y-4">
            ...
            <div class="bg-[var(--adm-surface)] border border-[rgba(212,185,154,0.10)] p-6">
                ...
                <form action="{{ route('admin.product-requests.update', $productRequest) }}" method="POST" class="space-y-4">
                    ...
                    <div>
                        <label class="block text-[10px] uppercase tracking-widest text-text-muted mb-2">Note to Customer <span class="normal-case tracking-normal text-text-dark/60 text-xs">(optional)</span></label>
