@extends('layouts.app')
@section('title', 'Shipping & Returns — Aurachell')
@section('meta_description', 'Aurachell delivery information, shipping fees, returns and refund policy.')
...
<div class="bg-sage/5 border-b border-sand/30 py-10">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <nav class="flex items-center gap-2 text-[10px] text-text-muted mb-4 font-sans tracking-[0.2em] uppercase">
            ...
            <span class="text-text-dark">Shipping & Returns</span>
        </nav>
        <h1 class="font-display text-4xl lg:text-5xl text-text-dark tracking-tight">Shipping & Returns</h1>
    </div>
</div>
...
<div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
    ...
    <div class="mt-12 pt-8 border-t border-sand/30">
        <p class="text-sm text-text-muted font-sans">Questions about your order? <a href="{{ route('contact') }}" class="text-sage underline">Contact us</a>.</p>
    </div>
</div>
@endsection
