...
{{-- Order reference --}}
<table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%"
       style="background:rgba(55,18,32,0.10);border:1px solid rgba(55,18,32,0.20);padding:20px 28px;margin:24px 0;">
    <tr>
        ...
        <td width="50%" style="vertical-align:top;padding-left:12px;text-align:right;">
            ...
            <p style="font-family:Georgia,serif;font-size:13px;color:#371220;margin:0;">{{ $order->delivered_at?->format('d F Y') ?? $order->updated_at->format('d F Y') }}</p>
        </td>
    </tr>
</table>
...
{{-- Review CTA --}}
<table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%"
       style="background:rgba(55,18,32,0.04);border-left:2px solid #371220;padding:24px 26px;margin:0 0 28px;">
    <tr>
        <td>
            ...
            <p style="font-family:Arial,sans-serif;font-size:13px;color:rgba(55,18,32,0.55);margin:0 0 20px;line-height:1.6;">
...
<table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%"
    ...
    <tr>
        <td>
            <p style="font-family:Arial,sans-serif;font-size:11px;letter-spacing:0.16em;text-transform:uppercase;color:rgba(55,18,32,0.38);margin:0 0 12px;">
                How would you rate your experience?
            </p>
            @for($i = 1; $i <= 5; $i++)
            <a href="{{ route('account.reviews') }}?order={{ $order->order_number }}&rating={{ $i }}"
               style="display:inline-block;font-size:22px;color:#371220;text-decoration:none;margin:0 3px;">★</a>
            @endfor
        </td>
    </tr>
</table>

<p style="font-family:Arial,sans-serif;font-size:12px;color:rgba(55,18,32,0.40);text-align:center;margin:0;">
