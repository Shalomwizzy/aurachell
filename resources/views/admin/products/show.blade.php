...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
    <div class="lg:col-span-2 space-y-6">
        <div class="bg-[var(--adm-surface)] border border-[rgba(212,185,154,0.10)] p-6">
            <div class="grid grid-cols-2 gap-8 mb-6">
                ...
                <div class="aspect-square bg-[rgba(212,185,154,0.10)] overflow-hidden">
    ...
    <div class="space-y-6">
        <div class="bg-[var(--adm-surface)] border border-[rgba(212,185,154,0.10)] p-6 space-y-3 text-sm">
            ...
            <div class="flex justify-between"><span class="text-text-muted">Status</span><span class="{{ $product->is_active ? 'text-bronze' : 'text-mahogany' }}">{{ $product->is_active ? 'Active' : 'Inactive' }}</span></div>
