...
<div style="display:flex;gap:16px;align-items:flex-start;margin-bottom:20px;padding-bottom:20px;border-bottom:1px solid rgba(255,255,255,0.05);">
    <div style="flex:1;">
        <p style="margin:0 0 4px;font-size:15px;color:#1E0C14;">{{ $product->name }}</p>
        <p style="margin:0;font-size:13px;color:#C9A96F;">₦{{ number_format($product->price) }}</p>
    ...
    <a href="{{ route('product.show', $product->slug) }}"
       style="display:inline-block;padding:9px 20px;background:#371220;color:#FAF5ED;text-decoration:none;font-size:10px;letter-spacing:0.15em;text-transform:uppercase;font-family:Arial,sans-serif;white-space:nowrap;">
        View
    </a>
</div>
@endif
