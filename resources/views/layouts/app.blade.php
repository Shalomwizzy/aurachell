...
<body class="bg-surface" x-data="{ cartOpen: false, searchOpen: false, mobileMenuOpen: false }" @close-cart.window="cartOpen = false">
        ...
        <nav class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16 lg:h-20">
                ...
                <a href="{{ route('home') }}" class="flex-shrink-0">
                    @if($logo)
                    <img src="{{ asset('images/' . $logo) }}" alt="Aurachell" class="h-14 w-auto dark:brightness-0 dark:invert">
                    @else
                ...
                <div class="flex items-center gap-3">
                    ...
                    <button x-data="themeToggle()" x-cloak @click="toggle()"
    ...
    <div class="fixed bottom-6 right-6 z-50"
        ...
        <div x-show="open"
            ...
            <div class="px-4 py-3.5 flex items-center gap-3" style="background:rgba(55,18,32,0.90); border-bottom:1px solid rgba(55,18,32,0.1);">
                ...
                <button @click="open = false" class="p-1 rounded hover:opacity-70 transition-opacity" style="color:rgba(201,169,111,0.40);">
                    ...
                    <div>
                        ...
                        <div class="flex flex-wrap gap-2 mt-2">
                            <button @click="setQuick('What diffusers do you have?')"
                                    ...
                                    style="border-color:rgba(201,169,111,0.4);color:rgba(201,169,111,0.70);">
    ...
    <div id="cookie-banner"
         ...
         style="background:#371220;border-top:1px solid rgba(55,18,32,0.18);">
