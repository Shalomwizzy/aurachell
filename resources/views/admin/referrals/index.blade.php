...
<div class="p-6 space-y-6 max-w-7xl">
    ...
    <div class="flex items-center justify-between gap-4 flex-wrap">
        ...
        <a href="{{ route('admin.referrals.settings') }}"
           ...
           style="background:rgba(201,169,111,0.10);color:var(--adm-gold);border:1px solid rgba(201,169,111,0.25);"
           onmouseover="this.style.background='rgba(201,169,111,0.18)'" onmouseout="this.style.background='rgba(201,169,111,0.10)'">
    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div class="rounded-sm p-4" style="background:var(--adm-surface-alt);border:1px solid var(--adm-border);">
            ...
            <div class="mt-3 h-1 rounded-full overflow-hidden" style="background:rgba(201,169,111,0.15);">
    ...
    <div class="grid lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 rounded-sm overflow-hidden" style="background:var(--adm-surface-alt);border:1px solid var(--adm-border);">
            <div class="px-5 py-4 border-b flex items-center justify-between" style="border-color:var(--adm-border);">
                ...
                <span class="text-[11px] px-2.5 py-1 rounded-full" style="background:rgba(201,169,111,0.12);color:var(--adm-muted);">
            ...
            <div class="overflow-x-auto">
                <table class="w-full">
                    ...
                    <tbody>
                        ...
                        <tr style="border-bottom:1px solid var(--adm-border);" class="transition-colors hover:bg-[rgba(212,185,154,0.03)]">
                            ...
                            <td class="px-4 py-3.5">
                                <div class="flex items-center gap-2.5">
                                    <div class="w-7 h-7 rounded-full flex items-center justify-center text-[11px] font-semibold flex-shrink-0"
                                         style="background:rgba(201,169,111,0.15);color:var(--adm-muted);">
                ...
                <div class="px-5 py-3.5 {{ !$loop->last ? 'border-b' : '' }}" style="border-color:var(--adm-border);">
                    <div class="flex items-center gap-3 mb-2">
                        <span class="w-5 h-5 rounded-full flex items-center justify-center text-[10px] font-bold flex-shrink-0"
                              style="{{ $i === 0 ? 'background:rgba(201,169,111,0.3);color:var(--adm-gold);' : 'background:rgba(201,169,111,0.1);color:var(--adm-muted);' }}">
                            {{ $i + 1 }}
                        </span>
                    ...
                    <div class="h-1 rounded-full overflow-hidden" style="background:rgba(201,169,111,0.12);">
                        <div class="h-full rounded-full" style="width:{{ round($user->rewarded_count / $maxCount * 100) }}%;background:{{ $i === 0 ? 'var(--adm-gold)' : 'rgba(201,169,111,0.4)' }};transition:width .4s;"></div>
                    </div>
                </div>
                @empty
