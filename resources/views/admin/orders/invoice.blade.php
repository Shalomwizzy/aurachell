...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .brand-name { font-family: Georgia, serif; font-size: 24px; letter-spacing: 0.2em; text-transform: uppercase; color: #2F4A3A; }
        .brand-tagline { font-size: 11px; color: #999; letter-spacing: 0.15em; text-transform: uppercase; margin-top: 4px; }
        .invoice-title { text-align: right; }
        .invoice-title h1 { font-family: Georgia, serif; font-size: 28px; color: #2F4A3A; }
        ...
        thead tr { border-bottom: 2px solid #2F4A3A; }
        th { padding: 10px 12px; text-align: left; font-size: 10px; letter-spacing: 0.15em; text-transform: uppercase; color: #2F4A3A; font-weight: 600; }
        ...
        .totals-row.total { border-top: 2px solid #2F4A3A; padding-top: 12px; margin-top: 6px; font-family: Georgia, serif; font-size: 18px; color: #2F4A3A; font-weight: bold; }
...
<div class="container">
    ...
    <div class="totals">
        ...
        @if($order->discount > 0)
        <div class="totals-row" style="color:#2F4A3A;"><span>Discount</span><span>−₦{{ number_format($order->discount, 0) }}</span></div>
        @endif
