...
window.showToast = function(message, type = 'success') {
    ...
    el.className = `fixed top-24 right-4 z-[999] px-6 py-3 text-sm font-sans shadow-lg transition-all duration-300 translate-x-0 ${type === 'success' ? 'bg-[#6B2016] text-[#F5EDE4]' : 'bg-red-600 text-white'}`;
