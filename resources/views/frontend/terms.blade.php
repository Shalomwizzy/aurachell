@extends('layouts.app')
@section('title', 'Terms of Service — Aurachell')
@section('meta_description', 'Aurachell terms of service — ordering, payments, shipping, and your rights as a customer.')
...
<div class="bg-sage/5 border-b border-sand/30 py-10">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <nav class="flex items-center gap-2 text-[10px] text-text-muted mb-4 font-sans tracking-[0.2em] uppercase">
            ...
            <span class="text-text-dark">Terms of Service</span>
        </nav>
        <h1 class="font-display text-4xl lg:text-5xl text-text-dark tracking-tight">Terms of Service</h1>
    </div>
</div>
