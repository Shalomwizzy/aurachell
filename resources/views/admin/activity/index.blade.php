    ...
    <div class="mb-6 flex items-end justify-between gap-4 flex-wrap">
        ...
        <form method="POST" action="{{ route('admin.activity.clear') }}"
            ...
            <button type="submit"
                    ...
                    style="background:rgba(55,18,32,0.10);border:1px solid rgba(201,169,111,0.25);color:rgba(247,242,235,0.75);">
                Clear All Logs
            </button>
        </form>
    </div>
    ...
    <form method="GET" class="adm-card p-4 mb-6">
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3 items-end">
            ...
            <div class="flex gap-2">
                <button type="submit" class="flex-1 px-4 py-2.5 text-xs tracking-[0.2em] uppercase font-medium" style="background:var(--adm-accent);color:#FFFFFF;">Filter</button>
